...
## V29 · 비용 할당 태그는 **활성화해야** 청구서에 나타난다 — 확인됨

14장 구현자가 확인해 왔다. "태그만 붙이면 청구서가 갈린다"는 흔한 오해를 깨는 근거다.

> **You must activate both types of tags separately before they can appear** in Cost Explorer or
> on a cost allocation report.

**예상 밖의 단서 하나 — 탄력적 IP는 제외된다.**

> **Elastic IP addresses that are tagged do not appear on your cost allocation report.**

7·12장이 쌓아 온 EIP 실과 이어진다. 태그를 아무리 잘 붙여도 EIP만은 그 보고서에 안 나온다.
